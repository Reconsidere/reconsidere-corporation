...
export class SignUpComponent implements OnInit {
  ...
  veryfyBeforeSave() {
    if (!this.isLogged) {
      if (this.corporation.email === undefined || this.corporation.company === undefined || this.corporation.tradingName === undefined || this.corporation.phone === undefined || this.corporation.cellPhone === undefined || this.corporation.classification === undefined || this.termPrivacity === false || this.termService === false) {
