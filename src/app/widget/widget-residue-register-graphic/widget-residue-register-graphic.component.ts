...
@Component({
	selector: 'app-widget-residue-register-graphic',
	templateUrl: './widget-residue-register-graphic.component.html',
	styleUrls: [ './widget-residue-register-graphic.component.scss' ]
})
export class WidgetResidueRegisterGraphicComponent implements OnInit {
	page: number;
