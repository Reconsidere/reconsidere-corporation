...
@Component({
	selector: 'app-widget-entries-management-graphic',
	templateUrl: './widget-entries-management-graphic.component.html',
	styleUrls: [ './widget-entries-management-graphic.component.scss' ]
})
export class WidgetEntriesManagementGraphicComponent implements OnInit {
	page: number;
